...
* ``category: MIT with Export Control'' (source:
https://github.com/org-metaeffekt/metaeffekt-universe/blob/main/src/main/resources/ae-universe/[m]/[mi]/MIT-with-Export-Control.yaml[Metaeffekt
Universe] (CC-BY-4.0))
...
* *SPDX:* https://spdx.org/licenses/Xerox.json
...
* https://github.com/org-metaeffekt/metaeffekt-universe/blob/main/src/main/resources/ae-universe/[m]/[mi]/MIT-with-Export-Control.yaml[Metaeffekt
Universe] (CC-BY-4.0)
* https://github.com/org-metaeffekt/metaeffekt-universe/blob/main/src/main/resources/ae-universe/[x]/[xe]/Xerox-License.yaml[Metaeffekt
Universe] (CC-BY-4.0)
...
....
{
    ...
    "facts": {
        ...
        "SPDX": {
            ...
            "spdxDetailsURL": "https://spdx.org/licenses/Xerox.json",
