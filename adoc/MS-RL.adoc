...
retrieved object code", "description": "Use the fetched code as it is."
}, \{ "name": "Use the retrieved binaries", "description": "Use the
fetched binary as it is." }, \{ "name": "Use the retrieved executable",
"description": "Use the obtained executable as is." } ], "conditions":
...
"Provide the source code corresponding to the software or a file
containing the software or a part of it.", "type": "OBLIGATION" }, \{
...
relevant license.", "type": "OBLIGATION" } ] } } ]'' (source:
https://github.com/Hitachi/open-license[Hitachi open-license]
(CDLA-Permissive-1.0))
