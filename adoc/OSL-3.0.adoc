...
(source:
https://github.com/github/choosealicense.com/blob/gh-pages/_licenses/osl-3.0.txt[choosealicense.com]https://github.com/github/choosealicense.com/blob/gh-pages/LICENSE.md[MIT])
...
image:../dot/OSL-3.0.svg[image,title="dot"]