...
* ``category: CNRI Jython'' (source:
https://github.com/org-metaeffekt/metaeffekt-universe/blob/main/src/main/resources/ae-universe/[c]/[cn]/CNRI-Jython-License.yaml[Metaeffekt
Universe] (CC-BY-4.0))
...
* https://github.com/org-metaeffekt/metaeffekt-universe/blob/main/src/main/resources/ae-universe/[c]/[cn]/CNRI-Jython-License.yaml[Metaeffekt
Universe] (CC-BY-4.0)
* https://spdx.org/licenses/CNRI-Jython.html[SPDX] (all data [in this
