...
https://spdx.org/licenses/UPL-1.0.html[SPDX] (all data [in this
...
* ``category: UPL-1.0'' (source:
https://github.com/org-metaeffekt/metaeffekt-universe/blob/main/src/main/resources/ae-universe/[u]/[up]/UPL-1.0.yaml[Metaeffekt
Universe] (CC-BY-4.0))
