...
* ``category: Borceux'' (source:
https://github.com/org-metaeffekt/metaeffekt-universe/blob/main/src/main/resources/ae-universe/[b]/[bo]/Borceux-License.yaml[Metaeffekt
Universe] (CC-BY-4.0))
