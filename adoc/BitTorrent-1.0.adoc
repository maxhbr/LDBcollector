...
* ``category: BitTorrent'' (source:
https://github.com/org-metaeffekt/metaeffekt-universe/blob/main/src/main/resources/ae-universe/[b]/[bi]/BitTorrent-License-1.0.yaml[Metaeffekt
Universe] (CC-BY-4.0))
