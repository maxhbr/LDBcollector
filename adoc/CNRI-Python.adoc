...
(CDLA-Permissive-1.0))
* ``category: CNRI Open Source License Agreement'' (source:
https://github.com/org-metaeffekt/metaeffekt-universe/blob/main/src/main/resources/ae-universe/[c]/[cn]/CNRI-Open-Source-License-Agreement-(Python-1.6b1).yaml[Metaeffekt
Universe] (CC-BY-4.0))
