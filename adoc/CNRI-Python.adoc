...
https://github.com/org-metaeffekt/metaeffekt-universe/blob/main/src/main/resources/ae-universe/[c]/[cn]/CNRI-Open-Source-License-Agreement-(Python-1.6).yaml[Metaeffekt
Universe] (CC-BY-4.0))
