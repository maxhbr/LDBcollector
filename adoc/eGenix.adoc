...
* ``category: eGenix'' (source:
https://github.com/org-metaeffekt/metaeffekt-universe/blob/main/src/main/resources/ae-universe/[e]/[eg]/eGenix.com-Public-License-1.1.0.yaml[Metaeffekt
Universe] (CC-BY-4.0))
