...
* ``category: MulanPSL'' (source:
https://github.com/org-metaeffekt/metaeffekt-universe/blob/main/src/main/resources/ae-universe/[m]/[mu]/Mulan-Permissive-Software-License-1.yaml[Metaeffekt
Universe] (CC-BY-4.0))
