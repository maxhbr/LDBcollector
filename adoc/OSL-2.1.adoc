...
(CDLA-Permissive-1.0))
* ``category: OSL'' (source:
https://github.com/org-metaeffekt/metaeffekt-universe/blob/main/src/main/resources/ae-universe/[o]/[op]/Open-Software-License-2.1.yaml[Metaeffekt
Universe] (CC-BY-4.0))
...
* *SPDX:* https://spdx.org/licenses/OSL-2.1.json
...
....
{
    ...
    "facts": {
        ...
        "SPDX": {
            ...
            "spdxDetailsURL": "https://spdx.org/licenses/OSL-2.1.json",
