...
- OlAction {_action_schemaVersion = "0.1", _action_uri = "http://open-license.hitachi.com/actions/357", _action_baseUri = "http://open-license.hitachi.com/", _action_id = "actions/357", _action_name = To make the executable generated from the modified source code available as an application intended for use across the network., _action_description = }
