...
* ``category: NOSL'' (source:
https://github.com/org-metaeffekt/metaeffekt-universe/blob/main/src/main/resources/ae-universe/[n]/[ne]/Netizen-Open-Source-License-1.0.yaml[Metaeffekt
Universe] (CC-BY-4.0))
