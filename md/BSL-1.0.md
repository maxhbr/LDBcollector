...
-----------------------------
    ...
    - OlAction {_action_schemaVersion = "0.1", _action_uri = "http://open-license.hitachi.com/actions/160", _action_baseUri = "http://open-license.hitachi.com/", _action_id = "actions/160", _action_name = Display the object code generated from the modified source code, _action_description = }
    - OlAction {_action_schemaVersion = "0.1", _action_uri = "http://open-license.hitachi.com/actions/161", _action_baseUri = "http://open-license.hitachi.com/", _action_id = "actions/161", _action_name = Execute the object code generated from the modified source code., _action_description = }
    - OlAction {_action_schemaVersion = "0.1", _action_uri = "http://open-license.hitachi.com/actions/163", _action_baseUri = "http://open-license.hitachi.com/", _action_id = "actions/163", _action_name = Transmit the retrieved object code, _action_description = }
    - OlAction {_action_schemaVersion = "0.1", _action_uri = "http://open-license.hitachi.com/actions/165", _action_baseUri = "http://open-license.hitachi.com/", _action_id = "actions/165", _action_name = Transmit the object code generated from the modified source code., _action_description = }
    - OlAction {_action_schemaVersion = "0.1", _action_uri = "http://open-license.hitachi.com/actions/166", _action_baseUri = "http://open-license.hitachi.com/", _action_id = "actions/166", _action_name = Sublicense the object code generated from the modified source code, _action_description = }
    ...
    - OlAction {_action_schemaVersion = "0.1", _action_uri = "http://open-license.hitachi.com/actions/162", _action_baseUri = "http://open-license.hitachi.com/", _action_id = "actions/162", _action_name = Transmit the acquired source code without modification., _action_description = Transmit the acquired source code as it is.}
    - OlAction {_action_schemaVersion = "0.1", _action_uri = "http://open-license.hitachi.com/actions/164", _action_baseUri = "http://open-license.hitachi.com/", _action_id = "actions/164", _action_name = Transmit modified source code, _action_description = }
