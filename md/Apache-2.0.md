...
-   “category: Apache License” (source: [Metaeffekt
    Universe](https://github.com/org-metaeffekt/metaeffekt-universe/blob/main/src/main/resources/ae-universe/[a]/[ap]/Apache-License-2.0.yaml "Metaeffekt Universe")
    (CC-BY-4.0))
...
-   [OSADL License
    Checklist](https://www.osadl.org/fileadmin/checklists/unreflicenses/Apache-2.0.txt "OSADL License Checklist")
    (NOASSERTION)
