...

    {
        ...
        "facts": {
            ...
            "Hitachi open-license": {
                ...
                "_license_summary": {
                    "ja": "http://www.freetype.org/license.html[http://git.savannah.gnu.org/cgit/freetype/freetype2.git/tree/docs/FTL.TXT]"
                },
                "_license_description": {
                    "ja": "â\"package\"ã\"FreeType Project\"ã\"FreeType archive\"ã¯ã\"FreeType Project\"ã¨ãã¦èä½è(David Turner, Robert Wilhelm, and Werner Lemberg)ãé å¸ããåãã®ã½ã¼ã¹ã³ã¼ãããã¤ããªãé¢é£ææ¸ã®å¨ã¦ãããã\r\n\r\nâãµãã©ã¤ã»ã³ã¹ã¯ãæ¬ã©ã¤ã»ã³ã¹ãä»ä¸ãããèããååº¦ãç¬¬ä¸èã«ãã®ä»ä¸ãããã©ã¤ã»ã³ã¹ãä¾ä¸ãããã¨ãæãã "
                },
