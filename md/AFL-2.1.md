...
-----------------------------
    ...
    - OlAction {_action_schemaVersion = "0.1", _action_uri = "http://open-license.hitachi.com/actions/107", _action_baseUri = "http://open-license.hitachi.com/", _action_id = "actions/107", _action_name = Publicly display the executable generated from modified source code, _action_description = }
    ...
    Actions:
    - OlAction {_action_schemaVersion = "0.1", _action_uri = "http://open-license.hitachi.com/actions/253", _action_baseUri = "http://open-license.hitachi.com/", _action_id = "actions/253", _action_name = Use the contributor's name, trademark, or service mark to endorse or promote the derived product, _action_description = }
