        ...
        <div id="license_question1" class="terms_question_area">
					...
					<div id="license_question2" class="terms_question_area" style="display:none;">
						...
						<div class="radio-area">
                            ...
                            <b-form-group v-slot="{ ariaDescribedby }">
                            <b-form-radio v-model="selected" :aria-describedby="ariaDescribedby" value="A">A、文件级__弱限制型开源许可证</b-form-radio>
                            <b-form-radio v-model="selected" :aria-describedby="ariaDescribedby" value="B">B、库级__弱限制型开源许可证</b-form-radio>
                            <b-form-radio v-model="selected" :aria-describedby="ariaDescribedby" value="C">C、强限制型开源许可证</b-form-radio>
                            </b-form-group>
						</div>
					</div>
					<div id="license_question3" class="terms_question_area" style="display:none;">
						...
						<div class="radio-area">
                            ...
                            <b-form-radio v-model="selected" :aria-describedby="ariaDescribedby" value="A">A、不提及专利权</b-form-radio>
                            <b-form-radio v-model="selected" :aria-describedby="ariaDescribedby" value="B">B、明确授予专利权</b-form-radio>
                            <b-form-radio v-model="selected" :aria-describedby="ariaDescribedby" value="C">C、明确不授予专利权</b-form-radio>
						</div>
					</div>
					<div id="license_question4" class="terms_question_area" style="display:none;">
						...
						<div class="radio-area">
                            ...
                            <b-form-radio v-model="selected" :aria-describedby="ariaDescribedby" value="A">A、包含反专利诉讼条款</b-form-radio>
                            <b-form-radio v-model="selected" :aria-describedby="ariaDescribedby" value="B">B、不包含反专利诉讼条款</b-form-radio>
						</div>
					</div>
					<div id="license_question5" class="terms_question_area" style="display:none;">
						...
						<div class="radio-area">
                            ...
                            <b-form-radio v-model="selected" :aria-describedby="ariaDescribedby" value="A">A、不提及商标权</b-form-radio>
                            <b-form-radio v-model="selected" :aria-describedby="ariaDescribedby" value="B">B、明确不授予商标权</b-form-radio>
						</div>
					</div>
					<div id="license_question6" class="terms_question_area" style="display:none;">
						...
						<div class="radio-area">
                            ...
                            <b-form-radio v-model="selected" :aria-describedby="ariaDescribedby" value="A">A、网络交互公开源码</b-form-radio>
                            <b-form-radio v-model="selected" :aria-describedby="ariaDescribedby" value="B">B、网络交互不须公开源码</b-form-radio>
						</div>
					</div>
					<div id="license_question7" class="terms_question_area" style="display:none;">
						...
						<div class="radio-area">
                            ...
                            <b-form-radio v-model="selected" :aria-describedby="ariaDescribedby" value="A">A、是，包含“修改说明”</b-form-radio>
                            <b-form-radio v-model="selected" :aria-describedby="ariaDescribedby" value="B">B、否，不包含“修改说明”</b-form-radio>
						</div>
					</div>
                <b-button variant="success" @click="nextq">下一题</b-button>
    </div>
</template>
