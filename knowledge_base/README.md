# 文件介绍
本工具用到的知识库包括：“licenses_terms_63.csv”、“compatibility_63.csv”、“github_license_usage.csv”、“libraries.io_license_usage.csv”, 它们都被置于[files used for program input](./files%20used%20for%20program%20input/)文件夹下，可直接作为程序输入。
...
# File Introduction
The knowledge base used in this tool includes "licenses_terms_63.csv", "compatibility_63.csv", "github_license_usage.csv", "libraries.io_license_usage.csv". They are all placed in the [files used for program input](./files%20used%20for%20program%20input/) folder and can be used directly as program inputs.


1. [TermFeatures_63license_en.xlsx](./TermFeatures_63license_en.xlsx) describes the meanings of "basic information, preamble	definition, Copyright Grant, Petent Grant, Restriction of Trademark Rights, Copyleft, Network deployment, Modification Statement, Attribution Retention, Attribution Enhancement,	Express Acceptance, Patent Termination, Violation Termination,	Disclaimers, Proper Law, Instruction, Compatible Version,Secondary License,combinative compatibility of GPL" and compares the differences of these clauses among 63 open source licenses.
