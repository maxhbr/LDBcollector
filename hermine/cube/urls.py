...
urlpatterns = [
    ...
    path("license/<int:license_id>/export/", f_views.export_specific_license, name="export_license"),
    ...
    path("release/<int:release_id>/<int:generic_id>", f_views.release_generic, name="release_generic"),
    path("release/<int:release_id>/derogation/<int:usage_id>/", f_views.release_add_derogation, name="release_add_derogation"),
    path("release/<int:release_id>/send_derogation/<int:usage_id>/", f_views.release_send_derogation, name="release_send_derogation"),
    path("release/<int:release_id>/choice/<int:usage_id>/", f_views.release_add_choice, name="release_add_choice"),
    path("release/<int:release_id>/send_choice/<int:usage_id>/", f_views.release_send_choice, name="release_send_choice"),
    path("release/<int:release_id>/exploitation", f_views.release_exploitation, name="release_exploitation"),
    path("release/<int:release_id>/send_exploitation", f_views.release_send_exploitation, name="release_send_exploitation"),
...
release_router.register(r"validation-1", api_views.UnnormalisedUsagesViewSet, basename="validation-1")
release_router.register(r"validation-2", api_views.LicensesToCheckViewSet, basename="validation-2")
release_router.register(r"validation-3", api_views.LicensesUsagesViewSet, basename="validation-3")
release_router.register(r"validation-4", api_views.LicensesAgainstPolicyViewSet, basename="validation-4")
...
obligation_router.register(r"obligations", api_views.ObligationViewSet, basename="license-obligations")

product_router = routers.NestedSimpleRouter(router, r"api/products")
product_router.register(r"releases", api_views.ReleaseViewSet, basename="product-releases")

version_router = routers.NestedSimpleRouter(router, r"api/components")
version_router.register(r"versions", api_views.VersionViewSet, basename="component-versions")
