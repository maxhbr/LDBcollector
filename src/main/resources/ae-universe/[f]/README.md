...
|<sup>[FOSS License Exception 1.0]([fo]/FOSS-License-Exception-1.0.yaml)</sup>|<sup>FOSS Exception</sup>|<sup>FOSS-Exception-1.0</sup>| | |<sup> </sup>| |<sup>[dbmx-foss-exception-1.0.9](https://github.com/nexB/scancode-toolkit/blob/develop/src/licensedcode/data/licenses/dbmx-foss-exception-1.0.9.LICENSE)</sup>|<sup>exception</sup>|
