...
|<sup>[vsftpd OpenSSL exception]([vs]/vsftpd-OpenSSL-exception.yaml)</sup>|<sup>vsftpd-openssl-exception</sup>|<sup>vsftpd-OpenSSL-Exception</sup>|<sup>[vsftpd-openssl-exception](https://spdx.org/licenses/vsftpd-openssl-exception.html)</sup>| |<sup> </sup>| |<sup>[gpl-2.0 WITH generic-exception](https://github.com/nexB/scancode-toolkit/blob/develop/src/licensedcode/data/licenses/gpl-2.0 WITH generic-exception.LICENSE)</sup>|<sup>exception</sup>|
