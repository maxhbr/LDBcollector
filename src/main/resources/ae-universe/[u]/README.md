...
|[UCD Terms of Use]([uc]/UCD-Terms-of-Use.yaml)|UCD|UCD-TOU| | | | [unicode-mappings](https://github.com/nexB/scancode-toolkit/blob/develop/src/licensedcode/data/licenses/unicode-mappings.LICENSE) |terms|
...
|[Unicode Terms of Use (Data Files)]([un]/Unicode-Terms-of-Use-(Data-Files).yaml)|Unicode TOU|Unicode-TOU-Data-Files| | | | |terms|
...
|[Unsplash License]([un]/Unsplash-License.yaml)|Unsplash License|unsplash| | | [unsplash](https://github.com/nexB/scancode-toolkit/blob/develop/src/licensedcode/data/licenses/unsplash.LICENSE) | |terms|
...
|[UPX Exception]([up]/UPX-Exception.yaml)|UPX Exception|UPX-Exception| | | [upx-exception-2.0-plus](https://github.com/nexB/scancode-toolkit/blob/develop/src/licensedcode/data/licenses/upx-exception-2.0-plus.LICENSE) | |exception|
