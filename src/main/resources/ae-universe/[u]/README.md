...
|<sup><a name="UGUI-License">[UGUI License]([ug]/UGUI-License.yaml)</a></sup>|<sup>UGUI License</sup>|<sup>ugui</sup>| | | |<sup>[ugui](https://github.com/nexB/scancode-toolkit/blob/develop/src/licensedcode/data/licenses/ugui.LICENSE)</sup>| |<sup>terms</sup>|
|<sup><a name="ulem-License">[ulem License]([ul]/ulem-License.yaml)</a></sup>|<sup>ulem</sup>|<sup> </sup>|<sup>[ulem](https://spdx.org/licenses/ulem.html)</sup>| | | | |<sup>terms</sup>|
...
|<sup><a name="Utah-Raster-Toolkit-Run-Length-Encoded-License">[Utah Raster Toolkit Run Length Encoded License]([ut]/Utah-Raster-Toolkit-Run-Length-Encoded-License.yaml)</a></sup>|<sup>URT-RLE</sup>|<sup> </sup>|<sup>[URT-RLE](https://spdx.org/licenses/URT-RLE.html)</sup>| | | |<sup>[warranty-disclaimer](https://github.com/nexB/scancode-toolkit/blob/develop/src/licensedcode/data/licenses/warranty-disclaimer.LICENSE)</sup>|<sup>terms</sup>|
