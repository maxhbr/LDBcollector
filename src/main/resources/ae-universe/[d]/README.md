...
|<sup>[David M. Gay dtoa License]([da]/David-M.-Gay-dtoa-License.yaml)</sup>|<sup>dtoa</sup>|<sup> </sup>|<sup>[dtoa](https://spdx.org/licenses/dtoa.html)</sup>| | | |<sup>[x11-lucent](https://github.com/nexB/scancode-toolkit/blob/develop/src/licensedcode/data/licenses/x11-lucent.LICENSE)</sup>|<sup>terms</sup>|
...
|<sup>[DOC License (only copyright statement)]([do]/DOC-License-(only-copyright-statement).yaml)</sup>|<sup>DOC</sup>|<sup>DOC-copyright</sup>| | | | |<sup>[ace-tao](https://github.com/nexB/scancode-toolkit/blob/develop/src/licensedcode/data/licenses/ace-tao.LICENSE)</sup>|<sup>terms</sup>|
|<sup>[DOM4J License]([do]/DOM4J-License.yaml)</sup>|<sup>DOM4J</sup>|<sup>DOM4J</sup>| | | |<sup>[dom4j](https://github.com/nexB/scancode-toolkit/blob/develop/src/licensedcode/data/licenses/dom4j.LICENSE)</sup>|<sup>[dom4j](https://github.com/nexB/scancode-toolkit/blob/develop/src/licensedcode/data/licenses/dom4j.LICENSE)</sup>|<sup>terms</sup>|
