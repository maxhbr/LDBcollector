...
instance LicenseFactC OSADLRule where
  ...
  getImpliedStmts (OSADLRule _ rule) =
...
data OSADLMatrixCompatibility = OSADLMatrixCompatibility
  { _other :: LicenseName,
...
data OSADLMatrixLicense = OSADLMatrixLicense
  { _name :: LicenseName,
...
instance LicenseFactC OSADLMatrixLicense where
  ...
  getImpliedStmts (OSADLMatrixLicense _ cs) =
    let compatibilities = map (\(OSADLMatrixCompatibility other compatibility explanation) -> LicenseCompatibility other compatibility explanation) cs
