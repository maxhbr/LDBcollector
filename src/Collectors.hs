...
import           Collectors.MetaeffektUniverse          as X
...
allCollectors =
  let toTpl c = (getLicenseFactClassifier c, loadFacts c)
   in [ toTpl blueOakCollector
      ...
      , (metaeffektUniverseLFC, loadMetaeffektUniverseFacts)
