...
ocptTable :: Data.ByteString.ByteString
ocptTable = $(embedFile "data/OpenChainPolicyTemplate/Table.csv")

loadOCPTFacts :: IO Facts
loadOCPTFacts = do
  logThatFactsAreLoadedFrom "Open Chain Policy Template"
  return (loadOCPTFactsFromString (B.fromStrict ocptTable))
