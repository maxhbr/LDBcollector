...
We try to follow the [REUSE standard](https://reuse.software/). So if you add a new file or make significant changes to one, please add also the appropriate headers following the template:
